...
def solver():
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        for idx in idxs_users:
            ...
            global_model.eval()
            acc_weight[cnt], current_loss = test_inference(args, global_model, valid_dataset)
            cnt = cnt+1

        # update global weights
        # local_weights.append(copy.deepcopy(global_weights))
        global_weights = global_weights = avgSV_weights(local_weights, acc_weight)
